"""Node factory — collects all nodes and returns them as a dictionary."""
...
def get_all_nodes() -> dict:
    """Return a dictionary of all workflow nodes.

    This factory pattern makes testing and swapping implementations easy.
    """
    return {
